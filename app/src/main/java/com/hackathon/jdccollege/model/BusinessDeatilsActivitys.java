...
public class BusinessDeatilsActivitys extends AppCompatActivity {

    College college= Currents.currentcollege;
    Course currentcourse= Currents.currentcourse;
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    ...
                    tab1.setBusiness(college, currentcourse);
                    return tab1;
                case 1:
                    AttractionListTab tab2 = new AttractionListTab();
                    tab2.setBusiness(college,currentcourse);
                    return tab2;
                default:
                    BusinessDetailsTab tab3 = new BusinessDetailsTab();
                    tab3.setBusiness(college, currentcourse);
                    return tab3;
            }
        }
